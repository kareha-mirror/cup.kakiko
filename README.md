...
If you want to use larger dictionary, run `kakiko -download` which downloads [skk-edic-legacy-large.cdb](https://tea.kareha.org/ja/skk-e/raw/branch/main/legacy-cdb/skk-edic-legacy-large.cdb) and place it `$HOME/.config/kakiko/skk-edic-legacy-large.cdb`.
